...
{#if shouldDisplay}
    <!-- Overlay -->
    <div transition:fade|global={{ duration: 300, easing: cubicInOut }} class="fixed inset-0 z-40 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" onmouseup={closeModalCheck} role="button" tabindex="0">
